...
*** 加入swfupload   
** 复杂的form表单参数
<input type='text' name='contest[entities[][image_url]]' />

<% sponsoring.prizes.each do |prize| %>
<input type='hiden' name='contest[prizes[][id]]' value='<%= prize.id %>'>
<p>
<span>奖品类型:</span>
<%= select '', 'contest[prizes[][itype]]', options_for_contest_prize_itype, selected: prize.itype %>
</p>
<p>
<span>奖品概述:</span>
<input type='text' name='contest[prizes[][summary]]' value='<%= prize.summary%>' />
</p>
<p>
<span>奖品描述:</span>
<textarea name='contest[prizes[][description]]'><%= prize.description %></textarea>
</p>
<p>
<span>奖品数量:</span>
<input type='text' name='contest[prizes[][quantity]]' value='<%= prize.quantity%>' />
</p>
<p>
<span>奖品价值:</span>
<input type='text' name='contest[prizes[][value]]' value='<%= prize.value%>' />
</p>
<p>
<span>奖品图片:</span>
<input type='file' name='contest[prizes[][image]]' />
<span><%= image_tag prize.image_url %></span>
</p>
