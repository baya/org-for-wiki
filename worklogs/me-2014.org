...
**** safri用户授权后不跳转
- 把session挂在url后面
**** ie8：在比赛和奖品界面点击上传图片参数按钮后，界面背景为透明黑框但是没有弹出上传参数的有关提示框
- https://trello.com/c/w2ZlSyli/418-ie8
**** ie8：在我的排名界面点击上传图片参数后，界面变为黑屏没有弹出提示框
- https://trello.com/c/AxCAVhXX/407-ie8
**** 选择已经结束的比赛项目编辑该比赛，修改该比赛的时长为2周和开始时间为今天后，点击界面最下方的预览按钮，界面没有任何反应，停留在原界面上，界面的最左下角提示信息：网页上有错误。如图所示
- https://trello.com/c/qHPQRuqp/356-2
**** 在后台管理--创建比赛的界面，什么都不填写后点击完成创建按钮后没有任何的提示信息
- https://trello.com/c/ZpqUJhod/375--
**** 选择已经结束的表项目编辑修改比赛时长和开始时间后，点击完成创建按钮，界面无变化：最左下角显示：网页上有错误
- https://trello.com/c/K8QI9NEJ/357--
**** 后台管理--创建比赛界面，什么操作都不做点击界面最下方的预览按钮，界面无反应没有任何提示信息
